...
func (m *MockStakingKeeper) GetBondedValidatorsByPower(ctx types.Context) []stakingtypes.Validator {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) IterateBondedValidatorsByPower(arg0 types.Context, arg1 func(int64, stakingtypes.ValidatorI) bool) {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) IterateLastValidators(arg0 types.Context, arg1 func(int64, stakingtypes.ValidatorI) bool) {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) IterateValidators(arg0 types.Context, arg1 func(int64, stakingtypes.ValidatorI) bool) {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) Validator(arg0 types.Context, arg1 types.ValAddress) stakingtypes.ValidatorI {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) ValidatorByConsAddr(arg0 types.Context, arg1 types.ConsAddress) stakingtypes.ValidatorI {
	m.ctrl.T.Helper()
...
func (m *MockGravityKeeper) CreateContractCallTx(ctx types.Context, invalidationNonce uint64, invalidationScope bytes.HexBytes, address common.Address, payload []byte, tokens, fees []gravitytypes.ERC20Token) *gravitytypes.ContractCallTx {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateContractCallTx", ctx, invalidationNonce, invalidationScope, address, payload, tokens, fees)
	ret0, _ := ret[0].(*gravitytypes.ContractCallTx)
	return ret0
}
...
func (m *MockGravityKeeper) SetOutgoingTx(ctx types.Context, outgoing gravitytypes.OutgoingTx) {
	m.ctrl.T.Helper()
