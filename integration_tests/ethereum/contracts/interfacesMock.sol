...
interface ICellarPoolShare is IERC20 {
    ...
    /// @param token0 The token0 address which liquidity was increased
    /// @param token1 The token1 address which liquidity was increased
    ...
    /// @param token0 The token0 address which liquidity was decreased
    /// @param token1 The token1 address which liquidity was decreased
