...
| `domain` | [string](#string) |  | FQDN of the subscriber, max length of 256 |
...
| `publisher_domain` | [string](#string) |  | FQDN of the publisher, max length of 256 |
| `push_url` | [string](#string) |  | optional, only needs to be set if the PublisherIntent for this subscription uses the PUSH method, max length of 512 |
