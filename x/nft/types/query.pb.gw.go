...
var (
	pattern_Query_Supply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"sommelier", "v1", "nft", "collections", "denom_id", "supply"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Owner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sommelier", "v1", "nft", "nfts"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Collection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sommelier", "v1", "nft", "collections", "denom_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sommelier", "v1", "nft", "denoms", "denom_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sommelier", "v1", "nft", "denoms"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"sommelier", "v1", "nft", "nfts", "denom_id", "token_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
