...
var (
	...
	// TestingreinvestParams is a set of gravity params for testing
	threshold, _          = sdk.NewDecFromStr("0.66")
	TestingreinvestParams = types.Params{
...
func CreateTestEnv(t *testing.T) TestInput {
	...
	keyreinvest := sdk.NewKVStoreKey(types.StoreKey)
	...
	ms.MountStoreWithDB(keyreinvest, sdk.StoreTypeIAVL, db)
	...
	k.setParams(ctx, TestingreinvestParams)
