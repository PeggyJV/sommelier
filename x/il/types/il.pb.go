...
type Stoploss struct {
	...
	MaxSlippage types.DecCoin `protobuf:"bytes,3,opt,name=max_slippage,json=maxSlippage,proto3" json:"max_slippage" yaml:"max_slippage"`
	// starting token pair ration of the uniswap pool
	ReferencePairRatio types.DecCoin `protobuf:"bytes,4,opt,name=reference_pair_ratio,json=referencePairRatio,proto3" json:"reference_pair_ratio" yaml:"reference_pair_ratio"`
}
...
func (m *Stoploss) GetMaxSlippage() types.DecCoin {
	if m != nil {
...
func (m *Stoploss) GetReferencePairRatio() types.DecCoin {
	if m != nil {
		return m.ReferencePairRatio
	}
	return types.DecCoin{}
}
...
var fileDescriptor_ccb151ade557e4dd = []byte{
	...
	,
}
...
func (m *Stoploss) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.ReferencePairRatio.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x22
	{
		size, err := m.MaxSlippage.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
