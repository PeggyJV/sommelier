...
// 7seas domain
const SEVEN_SEAS_DOMAIN = "7seas.capital"
...
const SEVEN_SEAS_PUBLISHER_CA = `-----BEGIN CERTIFICATE-----
...
const FIGMENT_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const STANDARD_CRYPTO_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const ROCKAWAY_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const BLOCKSCAPE_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const SIMPLY_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const PUPMOS_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const LAVENDER_FIVE_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const POLKACHU_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const STAKECITO_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const CHORUS_ONE_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const IMPERATOR_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const TEKU_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const FORBOLE_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const BOUBOU_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const SLEEPY_KITTEN_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const EVERSTAKE_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const TESSELATED_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const ZTAKE_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const TWO_BUCK_CHUCK_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const COSMOSTATION_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const MCB_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const POLYCHAIN_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const KINGSUPER_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const CHILL_VALIDATION_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const CHAINNODES_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
...
const SEVEN_SEAS_SUBSCRIBER_CA = `-----BEGIN CERTIFICATE-----
