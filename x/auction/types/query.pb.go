...
func (m *QueryEndedAuctionsRequest) GetPagination() *Pagination {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryEndedAuctionsResponse) GetNextPage() uint64 {
	if m != nil {
		return m.NextPage
	}
	return 0
...
func (m *QueryBidsByAuctionRequest) GetPagination() *Pagination {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryBidsByAuctionResponse) GetNextPage() uint64 {
	if m != nil {
		return m.NextPage
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Pagination)(nil), "auction.v1.Pagination")
}
...
var fileDescriptor_73c48d70714d6628 = []byte{
	...
	,
}
...
func (m *QueryEndedAuctionsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.NextPage != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.NextPage))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Auctions) > 0 {
...
func (m *QueryEndedAuctionsResponse) Size() (n int) {
	...
	if m.NextPage != 0 {
		n += 1 + sovQuery(uint64(m.NextPage))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextPage |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
