...
async function runTest() {
  ...
  const signer = await lp_signer.getAddress()
  const payload = logicContract.interface.encodeFunctionData("redeemLiquidityETH", [
    usdc_address,
    lp_balance_to_send,
    0,
    0,
  ...
  console.log("redeemLiquidityETH")
  console.log("signer", signer)
  console.log("payload", payload)
  console.log("usdc_address", usdc_address)
  console.log("lp_balance_to_send", lp_balance_to_send)
  console.log("timestamp", 4766922941000)
  ...
  const payload2 = logicBatch.interface.encodeFunctionData("logicBatch", [
    txAmounts,
    txPayloads,
  ...
  console.log("logicBatch")
  console.log("txAmounts", txAmounts)
  console.log("payload2", payload2)
  console.log("txPayloads", txPayloads)
  console.log("logicContract.address", logicContract.address)
  console.log("usdc_eth_lp.address", usdc_eth_lp.address)
