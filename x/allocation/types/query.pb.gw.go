...
var (
	...
	pattern_Query_QueryAllocationPrecommit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sommelier", "allocation", "v1", "prevotes", "validator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryAllocationCommit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sommelier", "allocation", "v1", "votes", "validator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryCommitPeriod_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sommelier", "allocation", "v1", "vote_period"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_QueryAggregateData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"sommelier", "allocation", "v1", "aggregate_data", "id", "type"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryLatestPeriodAggregateData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sommelier", "allocation", "v1", "aggregate_data"}, "", runtime.AssumeColonVerbOpt(false)))
)
