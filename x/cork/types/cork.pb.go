...
type CorkIDHash struct {
	Id   uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Hash []byte `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"`
}

func (m *CorkIDHash) Reset()         { *m = CorkIDHash{} }
func (m *CorkIDHash) String() string { return proto.CompactTextString(m) }
func (*CorkIDHash) ProtoMessage()    {}
func (*CorkIDHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_1219f78116b242b2, []int{4}
}
func (m *CorkIDHash) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CorkIDHash) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CorkIDHash.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CorkIDHash) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CorkIDHash.Merge(m, src)
}
func (m *CorkIDHash) XXX_Size() int {
	return m.Size()
}
func (m *CorkIDHash) XXX_DiscardUnknown() {
	xxx_messageInfo_CorkIDHash.DiscardUnknown(m)
}

var xxx_messageInfo_CorkIDHash proto.InternalMessageInfo

func (m *CorkIDHash) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *CorkIDHash) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CorkIDHash)(nil), "cork.v2.CorkIDHash")
}
...
var fileDescriptor_1219f78116b242b2 = []byte{
	...
	,
}
...
func (m *CorkIDHash) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CorkIDHash) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CorkIDHash) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Hash) > 0 {
		i -= len(m.Hash)
		copy(dAtA[i:], m.Hash)
		i = encodeVarintCork(dAtA, i, uint64(len(m.Hash)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
...
func (m *CorkIDHash) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CorkIDHash: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CorkIDHash: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
