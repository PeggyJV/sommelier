...
// Source: /Users/bolten/code/go/pkg/mod/github.com/cosmos/ibc-go/v7@v6.2.0/modules/core/05-port/types/module.go
...
func (mr *MockMiddlewareMockRecorder) SendPacket(ctx, chanCap, sourcePort, sourceChannel, timeoutHeight, timeoutTimestamp, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendPacket", reflect.TypeOf((*MockMiddleware)(nil).SendPacket), ctx, chanCap, sourcePort, sourceChannel, timeoutHeight, timeoutTimestamp, data)
}
