...
func TestExportInitGenesis(t *testing.T) {
	...
	input.OracleKeeper.SetUSDExchangeRate(input.Ctx, "denom", sdk.NewDec(123))
	input.OracleKeeper.AddAggregateExchangeRatePrevote(input.Ctx, types.NewAggregateExchangeRatePrevote(types.AggregateVoteHash{123}, keeper.ValAddrs[0], int64(2)))
	input.OracleKeeper.AddAggregateExchangeRateVote(input.Ctx, types.NewAggregateExchangeRateVote(sdk.DecCoins{{"foo", sdk.NewDec(123)}}, keeper.ValAddrs[0]))
