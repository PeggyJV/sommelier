...
var (
	...
	ErrLastSommTokenPriceTooOld                         = sdkerrors.Register(ModuleName, 6, "last somm token price update too long ago, need to resubmit token prices and try again")
	...
	ErrConvertingStringToDec                            = sdkerrors.Register(ModuleName, 15, "could not convert string to dec")
	ErrAuctionNotFound                                  = sdkerrors.Register(ModuleName, 16, "auction not found")
	ErrInvalidAddress                                   = sdkerrors.Register(ModuleName, 17, "invalid address")
	ErrBidAuctionDenomMismatch                          = sdkerrors.Register(ModuleName, 18, "auction denom different from bid requested denom")
	ErrAuctionEnded                                     = sdkerrors.Register(ModuleName, 19, "auction ended")
	ErrMinimumPurchaseLargerThanBid                     = sdkerrors.Register(ModuleName, 20, "minimum purchase is larger than allocated bid amount")
	ErrBidSmallerThanMinimumPurchasePrice               = sdkerrors.Register(ModuleName, 21, "bid smaller than minimum purchase price")
	ErrInsufficientBid                                  = sdkerrors.Register(ModuleName, 22, "bid amount is too small to purchase any tokens on sale, please increase and try again")
	ErrMinimumPurchaseAmountLargerThanTokensRemaining   = sdkerrors.Register(ModuleName, 23, "minimum purchase amount is larger then the number of tokens remaining for sale")
)
